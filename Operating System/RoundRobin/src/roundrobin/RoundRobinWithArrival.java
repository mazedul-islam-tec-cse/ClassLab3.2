...
public class RoundRobinWithArrival {
    ...
    static int granttChart() {
        ...
        while (true) {
            ...
            for (int arrivalTimeCheck = 0; arrivalTimeCheck < n; arrivalTimeCheck++) {
                if(total == arrivalTime[arrivalTimeCheck])
                    i = arrivalTimeCheck;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter your brust and arrival time for each process : ");
        for (int i = 0; i < n; i++) {
